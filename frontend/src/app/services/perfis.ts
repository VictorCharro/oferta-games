...
export interface PerfilBloco { id: string; tipo: 'favoritos' | 'biblioteca' | 'atividade' | 'platinados' | 'wishlist' | 'texto' | 'imagem' | 'links'; titulo: string | null; conteudo: string | null; posicao: number; tamanho: 'pequeno' | 'medio' | 'largo' | 'completo'; visivel: boolean; tipoFundo: 'padrao' | 'cor' | 'imagem' | 'gradiente'; valorFundo: string | null; opacidade: number; corTexto: string | null; }
