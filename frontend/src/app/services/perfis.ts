...
export interface PerfilBloco { id: string; tipo: 'resumo_favoritos' | 'horas' | 'conquistas' | 'favoritos' | 'biblioteca' | 'atividade' | 'texto' | 'imagem' | 'links'; titulo: string | null; conteudo: string | null; posicao: number; tamanho: 'pequeno' | 'medio' | 'largo' | 'completo'; visivel: boolean; tipoFundo: 'padrao' | 'cor' | 'imagem' | 'gradiente'; valorFundo: string | null; opacidade: number; }
