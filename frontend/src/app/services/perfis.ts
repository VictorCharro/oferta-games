...
export interface PerfilPublico { handle: string; nomeExibicao: string; bio: string | null; avatarUrl: string | null; totalMinutos: number | null; conquistasDesbloqueadas: number | null; conquistasTotal: number | null; totalJogosBiblioteca: number | null; biblioteca: Array<{ appId: number; titulo: string; minutosJogadas: number; iconeHash: string | null; conquistasDesbloqueadas: number; conquistasTotal: number }>; favoritos: Array<{ slug: string | null; steamAppId: number | null; titulo: string; capaUrl: string | null; iconeHash: string | null; ehDlc: boolean | null; precoMinimo: number | null; precoRegular: number | null; favoritadoEm: string }>; atividades: Array<{ tipo: string; tituloJogo: string | null; detalhe: string | null; criadaEm: string }>; mostrarAtividades: boolean; }
