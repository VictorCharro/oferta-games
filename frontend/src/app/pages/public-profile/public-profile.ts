...
export class PublicProfile implements OnInit {
  ...
  async ngOnInit() { try { this.profile = await this.perfis.publico(this.route.snapshot.paramMap.get('handle') || ''); } catch { this.missing = true; } finally { this.cdr.detectChanges(); } }
