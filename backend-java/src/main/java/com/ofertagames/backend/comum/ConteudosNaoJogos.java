...
public final class ConteudosNaoJogos {
  private static final String REGEX_SQL = "(certification|e[- ]?learning|online business|programming bundle|cybersecurity|masterclass|tutorial|training course|course bundle)";
